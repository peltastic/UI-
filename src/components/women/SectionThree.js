...
function SectionThree() {
  return (
    <section className=" h-[40vh] relative">
      <div className="absolute ml-[25rem] text-primary -top-[45rem]">
        <div className="flex items-center mb-8">
          <div className="w-[1.5rem] h-[1.5rem] bg-color1 mr-4"></div>
          <h2 className="text-2xl">BLOG ARTICLE</h2>
        </div>
        <h1 className="text-[25rem] -mt-[10rem]">Big</h1>
        <h1 className="text-[25rem] text-color1 ml-[17rem] -mt-[17rem]">
          beauty
        </h1>
        <div className="flex w-[100%]  mb-[20rem] text-primary">
          <div className=" border-r text-5xl border-color1 pr-[4rem]  pb-[6rem]">
          ...
          <div className="  w-[50%] pb-4 pl-[4rem]">
            <p className="text-lg mt-[19rem]">
              <span>
        ...
        <div className="w-[70rem] absolute top-[20rem] left-[9rem] z-[-1]">
